...
const info = [
    ...
    },
    {
        icon: <FaEnvelope />,
        title: "Email",
        description: "contatovitorribeiro@gmail.com",
    },
    {
        icon: <FaMapMarkedAlt />,
        title: "Endereço",
                        ...
                        <Select>
                            ...
                            <SelectContent>
                                <SelectGroup>
                                    ...
                                    <SelectItem value="est">Aulas de Programação/BI</SelectItem> 
                                    <SelectItem value="cst">Web Development</SelectItem> 
                                    <SelectItem value="mst">Business Inteligence</SelectItem> 
                                    <SelectItem value="xst">Automação de Processos</SelectItem> 
                                </SelectGroup>
                            </SelectContent>
                        </Select>
                        {/* textarea */}
